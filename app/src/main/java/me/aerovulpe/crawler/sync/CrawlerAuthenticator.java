...
/**
 * Manages "Authentication" to Crawler's backend service.  The SyncAdapter framework
 ...
 */
public class CrawlerAuthenticator extends AbstractAccountAuthenticator {

    public CrawlerAuthenticator(Context context) {
        super(context);
    }
