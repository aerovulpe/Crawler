...
import me.aerovulpe.crawler.data.WebResponseCursor;
...
public class CachedWebRequestFetcher {
    ...
    /**
     * Read the content of an {@link java.io.InputStream} as String.
     *
     ...
     * @param forceFetchFromWeb whether the content should be fetched from the web, regardless of
    ...
    public CachedResponse<String> cachedFetch(URL url, boolean forceFetchFromWeb) {
        ...
        synchronized (url) {
            ...
            if (!forceFetchFromWeb) {
                ...
                WebResponseCursor.CachedWebResponse response = fileSystemCache.get(url);
