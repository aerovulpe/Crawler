...
public class ImageAdapter extends ArrayAdapter<SlideshowPhoto> {
    ...
    public ImageAdapter(Context context, ISlideshowInstance slideshowInstance, int textViewResourceId, List<SlideshowPhoto> listObjects, File rootPhotoFolder, boolean doDisplayPhotoTitle) {
        ...
        mapWeakRefViews = new HashMap<>(500);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (slideshowView == null) {
            ...
            slideshowView = viewInflater.inflate(R.layout.slideshow_item, parent, false);
        }
        ...
        String LOADED_TAG = "Finished";
        if (copyDrawableFromCachedView) {
            ...
            if (cachedTag != null && cachedTag.equals(LOADED_TAG)) {
        ...
        if (slideShowImageDrawableMissing) {
            ...
            AsyncQueueableObject queueablePhotoObject = new QueueablePhotoObject(slideshowPhoto,
                    slideshowView, rootPhotoFolder, LOADED_TAG, screenWidthPx, screenHeightPx);
        ...
        if (!doDisplayPhotoTitle || slideshowPhoto.isPromotion() || isEmptyTitle) {
        ...
        WeakReference<View> weakRefView = new WeakReference<>(slideshowView);
