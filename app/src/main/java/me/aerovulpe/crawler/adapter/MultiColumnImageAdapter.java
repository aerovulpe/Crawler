 ...
 * possible.
 *
 * @param <T> the type of the data items being displayed and returned by the
 *            callback
...
public abstract class MultiColumnImageAdapter<T> extends BaseAdapter {
     ...
     * @param item the item that holds the data for the slot
     */
     ...
     *
     * @param parent the parent of the created view
     */
