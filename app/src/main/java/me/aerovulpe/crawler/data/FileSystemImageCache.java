...
public class FileSystemImageCache {
     ...
     *
     * @param url The {@link java.net.URL} of the photo to get.
     * @return The {@link android.graphics.Bitmap} object or <code>null</code>, if the database
     ...
     *
     * @param url      The URL of the photo to be put.
     * @param modified The modified/version string.
    ...
    /**
     * Same as {@link #put(java.net.URL, String, android.graphics.Bitmap)} but returns immediately. The
